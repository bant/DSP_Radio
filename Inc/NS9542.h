...
extern void NS9542_find_pg(uint8_t ialgn, uint8_t *fine_phase,
                           uint8_t *fine_gain, uint8_t *result_pg);
extern void NS9542_table_write(uint8_t *fine_p, uint8_t *fine_g);
extern void NS9542_band_freq_change(BandType band, uint16_t freq,
                                    uint8_t clk_sel);
